...
<html>
    ...
    <body>
        ...
        <form action="productSearchProcessing.jsp" onsubmit="return validateForm();" method="post" > 
            ...
            Product Stock Price:
            <input type="number" id="product_stock_priceS" name="product_stock_priceS" step="0.01"><br><br>
            ...
            Date Received:
            <input type="date" id ="product_date_receivedS" name="product_date_receivedS" ><br><br>
